      ...
      <div className="lower">
        <div className="body">
          <p id="leftText">
            ...
            tincidunt suscipit. Malesuada sit donec ultricies.
          </p>
          <p id="rightText">
            Ut ut sed turpis bibendum orci, tempor etiam morbi nibh. Dictum sem
            sit eu sit bibendum vitae. Scelerisque cras nulla tellus elementum
            cursus adipiscing mi est blandit. Eget nascetur odio lorem maecenas
            ultrices porttitor turpis. Id ac lobortis et, urna adipiscing enim
            netus ac in.
          </p>
        </div>
